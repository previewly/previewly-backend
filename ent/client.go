...
func (c *Client) Intercept(interceptors ...Interceptor) {
	...
	c.UploadImage.Intercept(interceptors...)
...
type (
	hooks struct {
		ErrorResult, Stat, Token, UploadImage, Url []ent.Hook
	}
	inters struct {
		ErrorResult, Stat, Token, UploadImage, Url []ent.Interceptor
	}
)
