...
func (m *ImageMutation) SetDestinationPath(s string) {
	m.destination_path = &s
}

// DestinationPath returns the value of the "destination_path" field in the mutation.
func (m *ImageMutation) DestinationPath() (r string, exists bool) {
...
// OldDestinationPath returns the old "destination_path" field's value of the Image entity.
// If the Image object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *ImageMutation) OldDestinationPath(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *ImageMutation) ResetDestinationPath() {
...
func (m *ImageMutation) SetExtraValue(s string) {
	m.extra_value = &s
}

// ExtraValue returns the value of the "extra_value" field in the mutation.
func (m *ImageMutation) ExtraValue() (r string, exists bool) {
	v := m.extra_value
	if v == nil {
		return
	}
...
// OldExtraValue returns the old "extra_value" field's value of the Image entity.
// If the Image object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *ImageMutation) OldExtraValue(ctx context.Context) (v *string, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *ImageMutation) ClearExtraValue() {
	m.extra_value = nil
	m.clearedFields[image.FieldExtraValue] = struct{}{}
}

// ExtraValueCleared returns if the "extra_value" field was cleared in this mutation.
func (m *ImageMutation) ExtraValueCleared() bool {
	_, ok := m.clearedFields[image.FieldExtraValue]
	return ok
}

// ResetExtraValue resets all changes to the "extra_value" field.
func (m *ImageMutation) ResetExtraValue() {
	m.extra_value = nil
	delete(m.clearedFields, image.FieldExtraValue)
}

// AddImageprocesIDs adds the "imageprocess" edge to the ImageProcess entity by ids.
func (m *ImageMutation) AddImageprocesIDs(ids ...int) {
...
func (m *ImageMutation) RemovedImageprocessIDs() (ids []int) {
...
func (m *ImageMutation) ImageprocessIDs() (ids []int) {
...
func (m *ImageMutation) ResetImageprocess() {
	m.imageprocess = nil
...
func (m *ImageMutation) Fields() []string {
	...
	if m.destination_path != nil {
		fields = append(fields, image.FieldDestinationPath)
	}
	...
	if m.extra_value != nil {
		fields = append(fields, image.FieldExtraValue)
	}
	return fields
}
...
func (m *ImageMutation) ClearedFields() []string {
	var fields []string
	if m.FieldCleared(image.FieldExtraValue) {
		fields = append(fields, image.FieldExtraValue)
	}
	return fields
}
...
func (m *ImageMutation) AddedEdges() []string {
	...
	if m.imageprocess != nil {
		edges = append(edges, image.EdgeImageprocess)
	}
	return edges
}
...
type ImageProcessMutation struct {
	...
	appendprocesses    []types.ImageProcess
	created_at         *time.Time
...
func (m *ImageProcessMutation) SetProcessHash(s string) {
	m.process_hash = &s
}

// ProcessHash returns the value of the "process_hash" field in the mutation.
func (m *ImageProcessMutation) ProcessHash() (r string, exists bool) {
	v := m.process_hash
	if v == nil {
		return
	}
...
// OldProcessHash returns the old "process_hash" field's value of the ImageProcess entity.
// If the ImageProcess object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *ImageProcessMutation) OldProcessHash(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldProcessHash is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
		return v, errors.New("OldProcessHash requires an ID field in the mutation")
	}
	oldValue, err := m.oldValue(ctx)
	if err != nil {
		return v, fmt.Errorf("querying old value for OldProcessHash: %w", err)
	}
	return oldValue.ProcessHash, nil
}

// ResetProcessHash resets all changes to the "process_hash" field.
func (m *ImageProcessMutation) ResetProcessHash() {
	m.process_hash = nil
}

// SetProcesses sets the "processes" field.
func (m *ImageProcessMutation) SetProcesses(tp []types.ImageProcess) {
	m.processes = &tp
	m.appendprocesses = nil
}

// Processes returns the value of the "processes" field in the mutation.
func (m *ImageProcessMutation) Processes() (r []types.ImageProcess, exists bool) {
	v := m.processes
	if v == nil {
		return
	}
...
// OldProcesses returns the old "processes" field's value of the ImageProcess entity.
// If the ImageProcess object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *ImageProcessMutation) OldProcesses(ctx context.Context) (v []types.ImageProcess, err error) {
	if !m.op.Is(OpUpdateOne) {
...
// AppendProcesses adds tp to the "processes" field.
func (m *ImageProcessMutation) AppendProcesses(tp []types.ImageProcess) {
	m.appendprocesses = append(m.appendprocesses, tp...)
}

// AppendedProcesses returns the list of values that were appended to the "processes" field in this mutation.
func (m *ImageProcessMutation) AppendedProcesses() ([]types.ImageProcess, bool) {
	if len(m.appendprocesses) == 0 {
		return nil, false
	}
	return m.appendprocesses, true
}

// ResetProcesses resets all changes to the "processes" field.
func (m *ImageProcessMutation) ResetProcesses() {
	m.processes = nil
	m.appendprocesses = nil
}
...
func (m *ImageProcessMutation) SetPathPrefix(s string) {
	m.path_prefix = &s
}

// PathPrefix returns the value of the "path_prefix" field in the mutation.
func (m *ImageProcessMutation) PathPrefix() (r string, exists bool) {
	v := m.path_prefix
	if v == nil {
		return
	}
...
// OldPathPrefix returns the old "path_prefix" field's value of the ImageProcess entity.
// If the ImageProcess object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *ImageProcessMutation) OldPathPrefix(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *ImageProcessMutation) ClearPathPrefix() {
	m.path_prefix = nil
	m.clearedFields[imageprocess.FieldPathPrefix] = struct{}{}
}

// PathPrefixCleared returns if the "path_prefix" field was cleared in this mutation.
func (m *ImageProcessMutation) PathPrefixCleared() bool {
	_, ok := m.clearedFields[imageprocess.FieldPathPrefix]
	return ok
}

// ResetPathPrefix resets all changes to the "path_prefix" field.
func (m *ImageProcessMutation) ResetPathPrefix() {
	m.path_prefix = nil
	delete(m.clearedFields, imageprocess.FieldPathPrefix)
}

// SetError sets the "error" field.
func (m *ImageProcessMutation) SetError(s string) {
	m.error = &s
}

// Error returns the value of the "error" field in the mutation.
func (m *ImageProcessMutation) Error() (r string, exists bool) {
	v := m.error
	if v == nil {
		return
	}
...
// OldError returns the old "error" field's value of the ImageProcess entity.
// If the ImageProcess object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *ImageProcessMutation) OldError(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *ImageProcessMutation) ClearError() {
	m.error = nil
	m.clearedFields[imageprocess.FieldError] = struct{}{}
}

// ErrorCleared returns if the "error" field was cleared in this mutation.
func (m *ImageProcessMutation) ErrorCleared() bool {
	_, ok := m.clearedFields[imageprocess.FieldError]
	return ok
}

// ResetError resets all changes to the "error" field.
func (m *ImageProcessMutation) ResetError() {
	m.error = nil
	delete(m.clearedFields, imageprocess.FieldError)
}

// SetUploadimageID sets the "uploadimage" edge to the Image entity by id.
func (m *ImageProcessMutation) SetUploadimageID(id int) {
	m.uploadimage = &id
}

// ClearUploadimage clears the "uploadimage" edge to the Image entity.
func (m *ImageProcessMutation) ClearUploadimage() {
	m.cleareduploadimage = true
}

// UploadimageCleared reports if the "uploadimage" edge to the Image entity was cleared.
func (m *ImageProcessMutation) UploadimageCleared() bool {
	return m.cleareduploadimage
}

// UploadimageID returns the "uploadimage" edge ID in the mutation.
func (m *ImageProcessMutation) UploadimageID() (id int, exists bool) {
	if m.uploadimage != nil {
		return *m.uploadimage, true
	}
	return
}

// UploadimageIDs returns the "uploadimage" edge IDs in the mutation.
// Note that IDs always returns len(IDs) <= 1 for unique edges, and you should use
// UploadimageID instead. It exists only for internal usage by the builders.
func (m *ImageProcessMutation) UploadimageIDs() (ids []int) {
	if id := m.uploadimage; id != nil {
		ids = append(ids, *id)
	}
	return
}

// ResetUploadimage resets all changes to the "uploadimage" edge.
func (m *ImageProcessMutation) ResetUploadimage() {
	m.uploadimage = nil
	m.cleareduploadimage = false
}
...
func (m *ImageProcessMutation) Fields() []string {
	...
	if m.process_hash != nil {
		fields = append(fields, imageprocess.FieldProcessHash)
	}
	if m.processes != nil {
		fields = append(fields, imageprocess.FieldProcesses)
	}
	if m.created_at != nil {
	...
	if m.path_prefix != nil {
		fields = append(fields, imageprocess.FieldPathPrefix)
	}
	if m.error != nil {
		fields = append(fields, imageprocess.FieldError)
	}
	return fields
}
...
func (m *ImageProcessMutation) ClearedFields() []string {
	var fields []string
	if m.FieldCleared(imageprocess.FieldPathPrefix) {
		fields = append(fields, imageprocess.FieldPathPrefix)
	}
	if m.FieldCleared(imageprocess.FieldError) {
		fields = append(fields, imageprocess.FieldError)
	}
	return fields
}
...
func (m *ImageProcessMutation) AddedEdges() []string {
	edges := make([]string, 0, 1)
	if m.uploadimage != nil {
		edges = append(edges, imageprocess.EdgeUploadimage)
	}
	return edges
}
...
func (m *ImageProcessMutation) AddedIDs(name string) []ent.Value {
	switch name {
	case imageprocess.EdgeUploadimage:
		if id := m.uploadimage; id != nil {
			return []ent.Value{*id}
		}
	}
